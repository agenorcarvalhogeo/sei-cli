...
ACTION_HINTS: dict[str, dict[str, Any]] = {
    ...
    "criar_processo": {
        "canonical_operation": "process-create-preview",
        "supported_now": True,
        "preflight_operations": [],
        "notes": "Criação canônica de processo via preview/confirm.",
    },
    "criar_documento": {
        "canonical_operation": "document-create-preview",
        "supported_now": True,
        "preflight_operations": ["process-read"],
        "notes": "Criação canônica de rascunho via preview/confirm.",
    },
    "analisar_pedido": {
        "canonical_operation": "process-read",
        "supported_now": True,
    ...
    "despachar": {
        ...
        "supported_now": True,
        "preflight_operations": ["process-read"],
        "notes": "Despacho começa pela criação canônica de documento e segue com edição/qualidade/leitura.",
    },
    "encaminhar": {
        "canonical_operation": "process-forward-preview",
        "supported_now": True,
        "preflight_operations": ["process-read"],
        "notes": "Encaminhamento canônico com preview/confirm e políticas de retorno/reabertura.",
    },
    "acostar_autos": {
        "canonical_operation": None,
        "supported_now": False,
